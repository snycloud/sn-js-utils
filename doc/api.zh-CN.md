...
```js
startsWith('2a2dfcfar1bzvb2','2'); // true
...
- 返回值 [return] {String} 大写转小写，小写转大写后的字符串
...
| 参数             | 类型                  | 是否必传         | 默认值            | 说明                                                         |
|:-----------     | :-----------          |:----------:     | :------:         | :------------------------------------------------------------ |
| input           | String                | 是              |                   | 输入字符串,如'abcdeabcdeabcde', 或 输入数字如 220022            |
| sub             | String                | 是              |                   | 输入字符串,如'ab',                                             |
- 返回值 [return] {String} 统计后字符串的个数
...
- 返回值 [return] {String} 返回字符串为空则使用默认字符串, 否则不变
...
- 返回值 [return] {String} 删掉特殊字符(英文状态下)后的字符串
...
- 返回值 [return] {String} 返回去掉中文字符后的字符串
...
- 返回值 [return] {String} 连字符转换成驼峰式后的字符串
