...
describe('测试 StringUtil 工具类', function () {
    ...
    describe('测试 endsWith 方法', function () {
        it('input为a2dfcfar1bzvb时,2的位置等于a2dfcfar1bzvb字符串总长度-1时,返回true', function () {
    ...
    describe('测试 swapCase 方法', function () {
        it('input为abcd时,返回为小写转大写后的字符串', function () {
            expect(utils.StringUtil.swapCase('abcde')).to.be.equal('ABCDE');
        });

        it('input为ABCD时,返回为大写转小写后的字符串', function () {
            expect(utils.StringUtil.swapCase('ABCDE')).to.be.equal('abcde');
        });
    });
    ...
    describe('测试 countMatches 方法', function () {
        it('input为空,sub为空时,返回字符串个数为0', function () {
            expect(utils.StringUtil.countMatches('', '')).to.be.equal(0);
        });
    ...
    describe('测试 isAlphaSpace 方法', function () {
        it('input为我是测试的 字符串时,返回为false', function () {
            expect(utils.StringUtil.isAlphaSpace('我是测试的 字符串')).to.be.equal(false);
        });
    ...
    describe('测试 isAlphanumeric 方法', function () {
        it('input为我是测试的 字符串时,返回为false', function () {
            expect(utils.StringUtil.isAlphanumeric('我是测试的 字符串')).to.be.equal(false);
        });
    ...
    describe('测试 isAlphanumericSpace 方法', function () {
        it('input为我是测试的 字符串时,返回为false', function () {
            expect(utils.StringUtil.isAlphanumericSpace('我是测试的 字符串')).to.be.equal(false);
        });
    ...
    describe('测试 isDecimal 方法', function () {
        it('input为我是测试的 字符串时,返回为false', function () {
            expect(utils.StringUtil.isDecimal('我是测试的 字符串')).to.be.equal(false);
        });
    ...
    describe('测试 isInteger 方法', function () {
        it('input为22.0022时,返回为false', function () {
    ...
    describe('测试 isNumericSpace 方法', function () {
        it('input为22.22时,返回为false', function () {
            expect(utils.StringUtil.isNumericSpace('22.22')).to.be.equal(false);
        });
    ...
    describe('测试 reverse 方法', function () {
        it('input为空时,返回为空', function () {
            expect(utils.StringUtil.reverse('')).to.be.equal('');
        });
        it('input为abcd时,返回为反转后的字符串', function () {
    ...
    describe('测试 removeSpecialCharacter 方法', function () {
        it('input为空时,返回为空', function () {
            expect(utils.StringUtil.removeSpecialCharacter('')).to.be.equal('');
        });
    ...
    describe('测试 format 方法', function () {
        it('input为空,arr为空时,返回为空', function () {
            expect(utils.StringUtil.format('', '')).to.be.equal('');
        });
    ...
    describe('测试 removeChinese 方法', function () {
        it('input为空时,返回为空', function () {
            expect(utils.StringUtil.removeChinese('')).to.be.equal('');
        });
    ...
    describe('测试 camelize 方法', function () {
        it('input为空时,返回为空', function () {
            expect(utils.StringUtil.camelize('')).to.be.equal('');
        });
    ...
    describe('测试 hyphenate 方法', function () {
        it('input为空时,返回为空', function () {
            expect(utils.StringUtil.hyphenate('')).to.be.equal('');
        });
